...
class GetProduct{
    ...
    func getStock(email : String , password : String, completionHandler: @escaping (_ error: String?, _ data:[[String:Any]]?) -> ()){
    ...
    private func getStockExt(completionHandler: @escaping (_ error: String?, _ data:[[String:Any]]?) -> ()){
           Alamofire.request(staticLinkers.link.getProducts, method: .get, parameters:nil, encoding: JSONEncoding.default, headers: ["Content-Type":"application/json","token":staticLinkers.token]).responseJSON(completionHandler: {(response) in
